\section{Leverage Point}
This section will highlight the process in finding the Leverage in our project, meaning to produce a list of keystones, that will help us solve the challenge mentioned in \ref{par:motivation}

Leverage Points follows a similar process as presented in \ref{sec:ecology-interface}, however, in Leverage we look at the internal points.
...
We will also utilize the two idea evaluation techniques mentioned in Essence, which we also used in \ref{sec:ecology-interface}.
...
An example of this can be seen in \ref{tab:pcrt-Flutter}, which is our table for the technology, "Flutter".
...
\ref{tab:pcrt-technologies-leverage} shows how we ranked the different technologies.
...
\begin{table}[h]
    ...
    \multirow{2}{*}{MariaDB} & \multicolumn{6}{c|}{Power} & 5 & \multicolumn{2}{c|}{\multirow{2}{*}{1}} \\ \cline{2-8}
     & Cost & -1 & Risk & -1 & Risk & -2 & -4 & \multicolumn{2}{c|}{} \\ \hline
    \end{tabular}
    }
...
The table for the repositories can be seen in \ref{app:pcrt-leverage}
