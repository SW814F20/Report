...
The method we will use is called \textbf{SWOT}, which stands for Strengths, Weaknesses, Opportunities, and Threats.
\autoref{tab:swot-mobile-platform-ecology} and \autoref{tab:swot-GitHub-ecology} shows the SWOT tables for Mobile Platform and GitHub, while the other SWOT analysis tables can be seen in~\autoref{app:swot-ecology}
...
\begin{table}[h]
    ...
    Opportunities & Threats \\ \hline
    \begin{tabular}[c]{@{}l@{}}More transparency for the customer\\ Closer collaboration between \\the customer and developers\end{tabular} & Third party integration problems \\ \hline
    \end{tabular}
...
The~\autoref{tab:swot-ranking-external-services} shows our ranking for external repositories, as we think that all of these ideas, try to solve the same problem, and are therefore alternatives to the solution.
