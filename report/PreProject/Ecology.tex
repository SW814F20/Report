\section{Ecology Interfaces}\label{sec:ecology-interface}
...
\ref{tab:swot-mobile-platform-ecology} and \ref{tab:swot-GitHub-ecology} shows the SWOT tables for Mobile Platform and GitHub
