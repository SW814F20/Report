\section{Review of the Sprint}\label{sec:review-sprint-anne}
...
\begin{landscape}
    ...
    \end{tabular} & \begin{tabular}[c]{@{}l@{}}Resolution:\\ \\ Prospect: The communication \\ between developers and \\ product owners will become easy.\\ \\ Warrant: Because software \\ development is expensive, \\ and could reduce the \\ cost and increase the quality\\ \\ Backing: Inexpensive, \\ popular platform. Extensible\end{tabular} 
            & \begin{tabular}[c]{@{}l@{}}Criteria for resolution expectations:\\ 
                ...
                \begin{minipage} [t] {0.3\textwidth} 
                    \begin{itemize}
                    \item \textit{Possible need an adapter between formalized requirements and system under test}
                   \end{itemize} 
                  \end{minipage}   
            \end{tabular} \\ \hline
         ...
         \end{tabular} & \begin{tabular}[c]{@{}l@{}}Features:\\ 
            \begin{minipage} [t] {0.325\textwidth} 
                \begin{itemize}
                    ...
                    \item App editor where product owner can formalize expected behaviour requirements for an interaction model
                    \item The app editor can suggest behaviour requirements for specific interaction elements
    ...
    \end{tabular} & \begin{tabular}[c]{@{}l@{}}Value Propositions:\\
        \begin{minipage} [t] {0.3\textwidth} 
            \begin{itemize}
                ...
                \item Levitate overhead for the customer in how to explain requirements
                \item Supply a unified framework for the developers for understanding requirements
