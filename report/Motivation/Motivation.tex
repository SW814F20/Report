The Manifesto for Agile Software Development states a set of values for what developers should strive for. These values are: \\
...
\noindent\makebox[\textwidth][c]{%
    \begin{minipage}[c]{0,8\textwidth}
    How can we improve the ability for customer collaboration in Agile Software Development, given constraints on the time commitment from the customers.
\end{minipage}} \\
\\
\noindent\hrulefill\par
\noindent\makebox[\textwidth][c]{%
    \begin{minipage}[c]{0,8\textwidth}
    How can we allow customers to participate in an Agile Software Development process without disrupting their tiem schedule.
\end{minipage}} \\
