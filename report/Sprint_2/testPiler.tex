...
A danger is that Dart is a language developed by a private company, meaning if the company decides to stop the development of the language or decides to remove the language completely, we would be in trouble.
