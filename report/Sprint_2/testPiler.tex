...
It also means that the language it self is not as mature as Java or C\#.
Another disadvantages is that Dart is a language developed by a private company, meaning if the company decides to stop the development of the language or decides to remove the language completely, we would be in trouble.
