...
Due to the inmatureness of Dart there has been situation where Linux users where unable to compile Dart code, due to a change in the Linux Kernel. 
Since Dart is Open Source and there is thereby no company behind with the incentiment to fix such issues, it took the community of Dart over a month to fix it.
...
The following is a code snippet of how as a consumer of the module, could compile their tests using the package.
