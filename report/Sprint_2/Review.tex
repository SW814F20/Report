...
\end{tabular} \\ \hline
    ...
    \end{tabular} & \begin{tabular}[c]{@{}l@{}}Value Propositions:\\
        \begin{minipage} [t] {0.35\textwidth} 
            \begin{enumerate}
                \item Translate Product Owner requirements to product requirements
                \item Help Product Owner to specify edge-case behaviours they may not realize naturally
                \item Levitate overhead for the Product Owner in how to explain requirements
                \item Supply an unified framework for the developers for understanding requirements
                \item Creates a compliance between Product Owner and developers
           \end{enumerate} 
          \end{minipage} 
         \end{tabular} & 
