...
However, due to the Covid-19 situation, the ability to perform the usability tests where no longer available and thus the tests where only planned for later testing purposes.
